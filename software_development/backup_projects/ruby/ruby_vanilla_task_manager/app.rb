...
list = UdaciList.new("Julia's Stuff")
...
new_list.find_method(2)
new_list.items[2].status_priority # it has a 'high' priority here
new_list.items[2].change_priority("low") # but I'm not very hungry atm
new_list.items[2].status_priority # returns a new "low" priority